...
describe('ClientsController', () => {
  ...
  it('should delegate create to service', async () => {
    const inputDto = { name: 'John', email: 'j@t.com', phone: '11999', salary: 5000, companyValue: 100000 };
  ...
  it('should delegate getDashboardStats to service', async () => {
    const expectedResponse = { totalClients: 5, totalSalary: 25000, totalCompanyValue: 500000, latestClients: [], chartData: [] };
